...
describe("protocol state honesty", () => {
  it.each([
    ...
    "AUTHORIZATION_RETRY_REQUIRED", "FULFILLMENT_PENDING", "FULFILLMENT_RETRY_REQUIRED",
  ...
  it.each([
    ...
    ["FULFILLED", "FULFILLED"], ["NOT_FULFILLED", "NOT_FULFILLED"], ["DISPUTED", "DISPUTED"],
  ...
  it.each([
    ...
    ["ASSESSMENT_RETRY_REQUIRED", "CHALLENGE_RETRY_REQUIRED"], ["RESOLVED", "CHALLENGE_RESOLVED"],
